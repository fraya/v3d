...
define test test-v3d-make ()
  let v = v3f(0.0, 0.0, 0.0);
  expect-equal(0.0, v.v3f-x);
  expect-equal(0.0, v.v3f-y);
  expect-equal(0.0, v.v3f-z);
end test;
...
define test test-addition ()
  let v1 = v3f(1.0, 1.0, 1.0);
  let v2 = v3f(2.0, 2.0, 2.0);
  let v3 = v3f(3.0, 3.0, 3.0);

  expect-equal(v3f-add(v1, v2), v3,
	       "Addition of vectors");
  expect-equal(v3f-add(v1, v2), v3f-add(v2, v1),
	       "Addition is commutative");
  expect-equal(v3f-add(v3f-add(v1, v2), v3),
	       v3f-add(v1, v3f-add(v2, v3)),
	       "Addition is associative");
  expect-equal(v3f-add($v3f-zero, v1), v1,
	       "0 is and additive identity");
  expect-equal($v3f-zero, v3f-add(v1, v3f-negative(v1)),
...
define benchmark addition-benchmark ()
  let x = v3f(3.0, -1.0, 5.0);
  let y = v3f(2.0, 1.0, -1.0);
